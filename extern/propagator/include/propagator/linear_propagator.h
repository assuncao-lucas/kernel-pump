...
{
public:
	LinearProp(Domain &d, const dominiqs::Constraint *c);
...
public:
	...
	PropagatorPtr analyze(Domain &d, const dominiqs::Constraint *c);
};
...
{
public:
	CardinalityProp(Domain &d, const dominiqs::Constraint *c);
	void createAdvisors(std::vector<AdvisorPtr> &advisors);
	void propagate();
	StatePtr getStateMgr();
	// output
...
{
public:
	KnapsackProp(Domain &d, const dominiqs::Constraint *c);
	void createAdvisors(std::vector<AdvisorPtr> &advisors);
	void propagate();
	StatePtr getStateMgr();
	// output
